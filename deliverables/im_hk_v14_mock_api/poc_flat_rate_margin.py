"""Run the HKv14 section 3.2.4.2 Flat Rate Margin POC over HTTP."""
...
def main() -> int:
    ...
    server = ThreadingHTTPServer(("127.0.0.1", 8768), MockIMHandler)
    thread = threading.Thread(target=server.serve_forever, daemon=True)
    thread.start()
    try:
        client = MockIMClient("http://127.0.0.1:8768")
        ...
        print("HKv14 Flat Rate Margin POC passed")
