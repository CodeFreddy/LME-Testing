"""Minimal Gherkin runner for the included Initial Margin HKv13 feature files."""
...
from features.step_definitions.initial_margin_steps import Context, dispatch
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Initial Margin HKv13 BDD feature files")
    parser.add_argument(
        "features",
        nargs="*",
        default=[str(Path("features") / "initial_margin")],
        help="Feature files or directories. Default: features/initial_margin",
    )
